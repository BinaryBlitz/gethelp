...
set :application, 'getthelp'
set :deploy_to, "/home/getthelp/#{application}"
set :use_sudo, false
set :unicorn_conf, "#{deploy_to}/current/config/unicorn.rb"
set :unicorn_pid, "#{deploy_to}/shared/pids/unicorn.pid"
set :normalize_asset_timestamps, false
set :rvm_ruby_string, 'ruby-2.3.0@getthelp'

set :scm, :git
set :repository, 'git@github.com:BinaryBlitz/gett_help.git'
